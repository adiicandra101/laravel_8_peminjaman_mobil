			...
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
			   ...
			   <li class="nav-item"><a class="nav-link" href="about.html">Tentang</a></li>
			    <li class="nav-item"><a class="nav-link" href="service.html">Lihat Mobil</a></li>
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="appoinment.html" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Sewa disini <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<p class="mb-4">Jika langsung datang ketempat untuk menyewa.</p>
					</div>
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<ul class="w-hours list-unstyled">
		                    <li class="d-flex justify-content-between">Senin - Kamis : <span>08.00 - 17.00 WIB</span></li>
		                    <li class="d-flex justify-content-between">Jumat : <span>08:00 - 11:00 WIB</span></li>
		                    <li class="d-flex justify-content-between">Sabtu - Minggu : <span>08:00 - 17:00 WIB</span></li>
		                </ul>
					</div>
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<span>Hubungi</span>
						<h4 class="mb-3">+62 81292690547</h4>
						<p>Kami akan melayani dengan senang hati jika anda ada terkendala dalam menyewa dengan catatan masih di jam kerja.</p>
					</div>
				</div>
			</div>
		</div>
