...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Sewa Mobil K.15.A</h2>
			</div>
			<div class="col-lg-8">
				<p>Sistem Sewa Mobil Di K.15.A melayani dengan sepenuh hati dan mengutamakan kepuasan pelanggannya. Kami menyediakan website dimana untuk mempermudah para pelanggan dalam menyewa sebuah mobil tanpa harus pergi ke tempatnya langsung</p>
		...
		<div class="row">
			<div class="col-lg-6 offset-lg-6">
				<div class="section-title">
					<h2 class="mb-4">Tentang Atasan Kami</h2>
			...
			<div class="col-lg-6 testimonial-wrap offset-lg-6">
				<div class="testimonial-block">
					<div class="client-info ">
						<h4>CEO!</h4>
						<span>Kesyza Andriana Hartuti</span>
					</div>
					<p>
						Beliau merupakan seorang CEO sekaligus pendiri Sewa Mobil K.15.A diusianya yang masih tergolong muda beliau sudah di akui oleh pemerintah setempat sebagai CEO termuda yang sukses.
					</p>
				...
				<div class="testimonial-block">
					...
					<p>
                        Beliau adalah investor resmi kami selama kurang lebih sudah 5 tahun lamanya, beliau lah yang senantiasa menyediakan mobil-mobil keluaran terbaru.	
                    </p>
					<i class="icofont-quote-right"></i>
				</div>
				...
				<div class="testimonial-block">
					...
					<p>
						Beliau merupakan yang mengelola sekaligus memantau setiap ada pesanan, selain itu beliau jugalah yang mengelola Sistem Sewa Mobil K.15.A ini.
                    </p>
					<i class="icofont-quote-right"></i>
				</div>
